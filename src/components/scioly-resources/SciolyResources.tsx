    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8 md:pt-16 md:pb-12">
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 w-full lg:w-auto">
          ...
          {[
            { id: 1, label: 'Life', colorClass: 'text-red-700 bg-red-100 dark:bg-red-500/20 dark:text-red-400 border-red-200 dark:border-red-500/30' },
            { id: 2, label: 'Earth', colorClass: 'text-green-700 bg-green-100 dark:bg-green-500/20 dark:text-green-400 border-green-200 dark:border-green-500/30' },
            { id: 3, label: 'Physical', colorClass: 'text-blue-700 bg-blue-100 dark:bg-blue-500/20 dark:text-blue-400 border-blue-200 dark:border-blue-500/30' },
            { id: 4, label: 'Inquiry', colorClass: 'text-yellow-700 bg-yellow-100 dark:bg-yellow-500/20 dark:text-yellow-400 border-yellow-200 dark:border-yellow-500/30' },
          ].map((cat) => (
            <button
              key={cat.id}
              ...
              className={`px-5 py-2.5 rounded-full font-bold border transition-all duration-300 cursor-pointer focus:outline-none ${
                selectedCategory === cat.id 
                  ? `${cat.colorClass} shadow-md scale-105`
      ...
      <div ref={gridRef} style={{ minHeight: gridMinHeight ? `${gridMinHeight}px` : 'auto' }} className="w-full">
        ...
        >
          <p className="text-2xl text-neutral-500 dark:text-neutral-400 font-semibold">No events found matching your search.</p>
        </motion.div>
      )}
      </div>
